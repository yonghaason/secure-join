...
namespace secJoin
{
    ...
    >
        ...
        public:
            ...
            //struct block
            //{
            //    static_assert(blocksize % 8 == 0, "");
            //    std::array<u8, blocksize / 8> mData;

            //    block() = default;
            //    block(const block&) = default;
            //    block& operator=(const block&) = default;

            //    block(const std::bitset<blocksize>& b)
            //    {
            //        memcpy(mData.data(), &b, sizeof(mData.size()));
            //    }

            //    operator std::bitset<blocksize>() const
            //    {
            //        std::bitset<blocksize> r;
            //        memcpy(&r, mData.data(), mData.size());
            //        return r;
            //    }

            //    block(u64 x)
            //    {
            //        memcpy(mData.data(), &x, sizeof(x));
            //        if (sizeof(x) < sizeof(mData))
            //        {
            //            memset(mData.data() + sizeof(x), 0, sizeof(mData) - sizeof(x));
            //        }
            //    }
            ...
            //    block operator>>(u64 shift) const
            //    {
            //        std::bitset<blocksize> r = *this;
            //        r >>= shift;
            //        return r;
            //    }
            //    block& operator<<=(u64 shift) 
            //    {
            //        std::bitset<blocksize> r = *this;
            //        r <<= shift;
            //        *this = r;
            ...
            //    std::bitset<blocksize>& asBitset()
            //    {
            //        return *(std::bitset<blocksize>*)this;
            //    }

            //    const std::bitset<blocksize>& asBitset() const
            //    {
            //        return *(const std::bitset<blocksize>*)this;
            //    }

            //    auto size() const { return blocksize; }
            //};
