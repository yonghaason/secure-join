...
namespace secJoin
{
	...
	//			{
	//				auto e = ki ? x(i, j) : oc::ZeroBlock;
	//				if (xk0_(i, j) != e)
	//					throw RTE_LOC;

	//				if (xk1_(i, j) != oc::ZeroBlock)
	//					throw RTE_LOC;
	//			}
	//		}
	//	}
	...
	//	// of the input x times the key mod 3. We store the LSB and MSB of the share separately.
	//	// Hence we need 2 * AltModWPrf::KeySize rows in xkShares
	//	xk0.resize(AltModPrf::KeySize, xt.cols(), oc::AllocType::Uninitialized);
	//	xk1.resize(AltModPrf::KeySize, xt.cols(), oc::AllocType::Uninitialized);
